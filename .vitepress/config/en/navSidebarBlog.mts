...
export const BlogData = [
  ...
  text: "Javascript",
  items: [
    {text: "Native AJAX asynchronous request", link: "/blog/js-ajax.md", time: "2020-07-24" },
    ...
    { text: "Self-encapsulated commonly used tool functions", link: "/blog/js-fun.md", time: "2023-05-11" },
  ],
  },
  {
  text: "Css",
  items: [
    ...
    { text: "CSS3 Transition Animation", link: "/blog/css-animation.md", time: "2021-08-03" },
  ],
  },
  {
