...
export const BlogData = [
  ...
  //     {text: "Browser Object Model BOM", link: "/en/blog/js-bom.md", time: "2021-01-29" },
  //     {text: "Canvas learning notes", link: "/en/blog/js-canvas.md", time: "2021-03-26" },
  //     {text: "Program naming formula and specifications", link: "/en/blog/js-standard.md", time: "2021-03-29" },
  //     {text: "touch touch events and common touch functions", link: "/en/blog/js-touch.md", time: "2021-07-18" },
