...
// base info
export const title: string = "Ape Code";
export const titleEn: string = "ApeCode";
export const description: string = "describe";
...
export const github: string = "https://github.com/minsion/apecode";

// doc label
export const outlineTitle: string = "Catalogue";
export const sidebarMenuLabel: string = "navigation";
export const docFooterPrev: string = "Previous";
export const docFooterNext: string = "Next";
export const returnToTopLabel: string = "Back to top";
export const darkModeSwitchLabel: string = "Exterior";
export const editLinkPattern: string = `${github}/blob/master/docs/:path`;
export const editLinkText: string = "Edit this page";
export const lastUpdatedText: string = "Last updated on";
